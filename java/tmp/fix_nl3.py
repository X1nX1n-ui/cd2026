...
# === 2. humanToCron ===
cn_regex = C("[") + C("一二三四五六七八九十两零半") + C("]+")
cn_map = C('"一":1,"二":2,"三":3,"四":4,"五":5,"六":6,"七":7,"八":8,"九":9,"十":10,"零":0,"两":2,"半":30')
...
new2 = (
    ...
    b"            var cn = {" + cn_map + b"};\n"
    b"            t = t.replace(/" + cn_regex + b"/g, function(m) { return cn[m] || m; });\n"
